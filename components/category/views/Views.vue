...
export default defineComponent({
  ...
  setup() {
    ...
    const nextPageUrl = ref(`api/en/category/views/views`)
      ...
      try {
        const response: CategoryViewsChild =
          await $axios.$get<CategoryViewsChild>(
            `api/${lang}/category/views/views`
          )

        nextPageUrl.value = `api/en/category/views/sub-more/views/${response.id}`
...
<template>
  <div id="views" ref="target" class="py-4">
    <v-container>
          ...
          <div class="col-span-full">
            <div class="grid grid-cols-1 xl:grid-cols-12 xl:grid-rows-2 gap-4">
              <article
                ...
                :key="post.id"
                class="col-auto xl:col-span- xl:row-span-2"
              >
